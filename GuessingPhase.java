...
public class GuessingPhase {
            ...
            if (input.equals("")) {
                ...
                if (containsNumbers(input) == true) {
                    ...
                    if (input.toLowerCase().equals(DrawingPhase.finalWord)) {
                        ...
                        File inputFile = new File("Txt/scores.txt");
                        File tempFile = new File("Txt/tempScores.txt");
                        ...
                        try {
                            ...
                            reader.close();
                            inputFile.delete();
                            tempFile.renameTo(new File("Txt/scores.txt"));
                        ...
                        try {
                            BufferedWriter bw = new BufferedWriter(new FileWriter("Txt/scores.txt", true));
    ...
    public String profanityFilter(String input) {
        try {
            BufferedReader in = new BufferedReader(new FileReader("Txt/censor.txt"));
            String str;
    ...
    private JComponent pics() {
        ...
        ImageIcon word1Icon = new ImageIcon(new ImageIcon("Drawings/word1.png").getImage().getScaledInstance(400, 200, Image.SCALE_DEFAULT));
        word1Img = new JLabel();
        word1Img.setIcon(word1Icon);

        pics.add(word1Img);

        ImageIcon word2Icon = new ImageIcon(new ImageIcon("Drawings/word2.png").getImage().getScaledInstance(400, 200, Image.SCALE_DEFAULT));
        word2Img = new JLabel();
        word2Img.setIcon(word2Icon);

        pics.add(word2Img);

        ImageIcon word3Icon = new ImageIcon(new ImageIcon("Drawings/word3.png").getImage().getScaledInstance(400, 200, Image.SCALE_DEFAULT));
        word3Img = new JLabel();
